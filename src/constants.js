...
export const from = "Johnny Doe";
export const profession = 'CEO';
export const photoURL = 'https://images.unsplash.com/photo-1590895340509-793cb98788c9?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2hpdGUlMjBndXl8ZW58MHx8MHx8fDA%3D';
...
//STRIPE
export const stripePlanIdOne = "price_1QERZOCCYa6cAnBn8P8r6xR9";
export const stripePlanIdTwo = "price_1QERZpCCYa6cAnBnXXlYiqR0";
